...
#define FRAC_BITS 4
#define NUM_PIXELS  (7 + 12) // 64
#define WS2812_PIN_BASE 29
#define delay_ms    10
...
int main() {
    ...
    while (1) {
        ...
        if (rand() & 1) dir = 0;
        printf("%s -- ", pattern_table[pat].name);
